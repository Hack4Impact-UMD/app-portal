...
- **Role-aware review tools** pair rubrics, notes, quick section navigation, and autosaved progress.
- **Admin dashboards** manage review status, assignments, qualified applicants, decisions, and confirmations.
- **Auto-assignment previews** draft reviewer assignment plans with room for manual adjustments.
